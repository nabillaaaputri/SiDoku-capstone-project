...
Digunakan oleh pengguna untuk mengakses seluruh fitur SiDoku.
https://sidoku.vercel.app

### Backend API
Menyediakan layanan autentikasi, manajemen produk, stok, pengeluaran, dan logika bisnis aplikasi.
...
Dashboard analitik berbasis Streamlit yang digunakan untuk eksplorasi data, visualisasi penjualan, dan evaluasi model. Dashboard ini tidak digunakan langsung oleh pengguna akhir.
