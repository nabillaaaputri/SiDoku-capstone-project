      ...
      <div className="space-y-4 sm:space-y-5">
        ...
        {recap.details.length > 0 && (
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
            <div className="group relative overflow-hidden rounded-[24px] border border-blue-100 bg-[linear-gradient(180deg,_#ffffff,_#eff6ff)] p-3 shadow-[0_10px_30px_rgba(15,23,42,0.06)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_40px_rgba(37,99,235,0.14)] min-h-[152px]">
              <div className="absolute inset-x-0 top-0 h-1 bg-[linear-gradient(90deg,_#60a5fa,_#2563eb)]" />
              <div className="flex items-start gap-3 pr-14">
                <div className="min-w-0 flex-1">
                  <p className="text-[11px] font-semibold uppercase tracking-wider text-blue-600/80">
                    <span className="block">Total</span>
                    <span className="block">Penjualan</span>
                  </p>
                  <p className="mt-2.5 max-w-[calc(100%-64px)] whitespace-nowrap text-[1.25rem] sm:text-xl lg:text-[1.25rem] font-extrabold text-slate-900 leading-none tabular-nums tracking-tight">
                    {formatIDR(totalPenjualan)}
                  </p>
                  <p className="mt-1.5 text-xs font-medium text-slate-500">nilai penjualan harian</p>
                </div>
                <div className="absolute right-3 top-3 flex h-10 w-10 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,_rgba(37,99,235,0.16),_rgba(96,165,250,0.1))] text-blue-600 shadow-inner ring-1 ring-blue-100">
                  <CircleDollarSign size={18} />
                </div>
              </div>
            </div>

            <div className="group relative overflow-hidden rounded-[24px] border border-rose-100 bg-[linear-gradient(180deg,_#ffffff,_#fff1f2)] p-3 shadow-[0_10px_30px_rgba(15,23,42,0.06)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_40px_rgba(244,63,94,0.14)] min-h-[152px]">
              <div className="absolute inset-x-0 top-0 h-1 bg-[linear-gradient(90deg,_#fda4af,_#e11d48)]" />
              <div className="flex items-start gap-3 pr-14">
                <div className="min-w-0 flex-1">
                  <p className="text-[11px] font-semibold uppercase tracking-wider text-rose-600/80">
                    <span className="block">Total</span>
                    <span className="block">HPP</span>
                  </p>
                  <p className="mt-2.5 max-w-[calc(100%-64px)] whitespace-nowrap text-[1.25rem] sm:text-xl lg:text-[1.25rem] font-extrabold text-slate-900 leading-none tabular-nums tracking-tight">
                    {formatIDR(totalHPP)}
                  </p>
                ...
                <div className="absolute right-3 top-3 flex h-10 w-10 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,_rgba(244,63,94,0.16),_rgba(251,113,133,0.1))] text-rose-600 shadow-inner ring-1 ring-rose-100">
                  <TrendingDown size={18} />
                </div>
              </div>
            </div>

            <div className="group relative overflow-hidden rounded-[24px] border border-emerald-100 bg-[linear-gradient(180deg,_#ffffff,_#f0fdf4)] p-3 shadow-[0_10px_30px_rgba(15,23,42,0.06)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_40px_rgba(34,197,94,0.14)] min-h-[152px]">
              ...
              <div className="flex items-start gap-3 pr-14">
                <div className="min-w-0 flex-1">
                  <p className="text-[11px] font-semibold uppercase tracking-wider text-emerald-600/80">
                    <span className="block">Laba</span>
                    <span className="block">Kotor</span>
                  </p>
                  <p className={`mt-2.5 max-w-[calc(100%-64px)] whitespace-nowrap text-[1.25rem] sm:text-xl lg:text-[1.25rem] font-extrabold leading-none tabular-nums tracking-tight ${labaKotor >= 0 ? "text-slate-900" : "text-rose-700"}`}>
                    {formatIDR(labaKotor)}
                  </p>
                  <p className="mt-1.5 text-xs font-medium text-slate-500">sebelum pengeluaran</p>
                </div>
                <div className="absolute right-3 top-3 flex h-10 w-10 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,_rgba(34,197,94,0.16),_rgba(134,239,172,0.1))] text-emerald-600 shadow-inner ring-1 ring-emerald-100">
                  <TrendingUp size={18} />
                </div>
              </div>
            </div>

            <div className="group relative overflow-hidden rounded-[24px] border border-orange-100 bg-[linear-gradient(180deg,_#ffffff,_#fff7ed)] p-3 shadow-[0_10px_30px_rgba(15,23,42,0.06)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_40px_rgba(249,115,22,0.14)] min-h-[152px]">
              <div className="absolute inset-x-0 top-0 h-1 bg-[linear-gradient(90deg,_#fdba74,_#f97316)]" />
              <div className="flex items-start gap-3 pr-14">
                <div className="min-w-0 flex-1">
                  <p className="text-[11px] font-semibold uppercase tracking-wider text-orange-600/80">
                ...
                <div className="absolute right-3 top-3 flex h-10 w-10 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,_rgba(249,115,22,0.16),_rgba(251,146,60,0.1))] text-orange-600 shadow-inner ring-1 ring-orange-100">
                  <ShoppingCart size={18} />
                </div>
              </div>
            </div>

            <div className={`group relative overflow-hidden rounded-[24px] border p-3 shadow-[0_10px_30px_rgba(15,23,42,0.06)] transition hover:-translate-y-0.5 ${labaBersihIsNegative ? "border-rose-100 bg-[linear-gradient(180deg,_#ffffff,_#fff1f2)] hover:shadow-[0_18px_40px_rgba(244,63,94,0.14)]" : "border-emerald-100 bg-[linear-gradient(180deg,_#ffffff,_#f0fdf4)] hover:shadow-[0_18px_40px_rgba(34,197,94,0.14)]"} min-h-[152px]`}>
              ...
              <div className="flex items-start gap-3 pr-14">
                <div className="min-w-0 flex-1">
                  <p className={`text-[11px] font-semibold uppercase tracking-wider ${labaBersihIsNegative ? "text-rose-600/80" : "text-emerald-600/80"}`}>
                    <span className="block">Laba</span>
                    <span className="block">Bersih</span>
                  </p>
                  <p className={`mt-2.5 max-w-[calc(100%-64px)] whitespace-nowrap text-[1.25rem] sm:text-xl lg:text-[1.25rem] font-extrabold leading-none tabular-nums tracking-tight ${labaBersihIsNegative ? "text-rose-700" : "text-slate-900"}`}>
                    {labaBersihDisplay}
                  </p>
                  <p className="mt-1.5 text-xs font-medium text-slate-500">setelah pengeluaran</p>
                </div>
                <div className={`absolute right-3 top-3 flex h-10 w-10 items-center justify-center rounded-2xl shadow-inner ring-1 ${labaBersihIsNegative ? "bg-[linear-gradient(135deg,_rgba(244,63,94,0.16),_rgba(251,113,133,0.1))] text-rose-600 ring-rose-100" : "bg-[linear-gradient(135deg,_rgba(34,197,94,0.16),_rgba(134,239,172,0.1))] text-emerald-600 ring-emerald-100"}`}>
                  <BarChart3 size={18} />
                </div>
              </div>
            </div>
